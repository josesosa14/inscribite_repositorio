...
<? } ?>
	...
	<select name="dianacimiento" id="dianacimiento" >
		<option></option>
		<? for($i=1;$i<=31;$i++){ ?><option value="<?=$i?>" <? if((substr($row['fechanac'],6,2)*1)==$i)echo'selected'?>><?=$i?></option> <? } ?>
	</select>
	</p>
	<p>
	...
	<select name="mesnacimiento" id="mesnacimiento" onchange="cantidias();">
		<option></option>
		<option value="01"<? if(substr($row['fechanac'],4,2)=="01")echo' selected="selected"'?>>Enero</option>
		<option value="02"<? if(substr($row['fechanac'],4,2)=="02")echo' selected="selected"'?>>Febrero</option>
		<option value="03"<? if(substr($row['fechanac'],4,2)=="03")echo' selected="selected"'?>>Marzo</option>
		<option value="04"<? if(substr($row['fechanac'],4,2)=="04")echo' selected="selected"'?>>Abril</option>
		<option value="05"<? if(substr($row['fechanac'],4,2)=="05")echo' selected="selected"'?>>Mayo</option>
		<option value="06"<? if(substr($row['fechanac'],4,2)=="06")echo' selected="selected"'?>>Junio</option>
		<option value="07"<? if(substr($row['fechanac'],4,2)=="07")echo' selected="selected"'?>>Julio</option>
		<option value="08"<? if(substr($row['fechanac'],4,2)=="08")echo' selected="selected"'?>>Agosto</option>
		<option value="09"<? if(substr($row['fechanac'],4,2)=="09")echo' selected="selected"'?>>Septiembre</option>
		<option value="10"<? if(substr($row['fechanac'],4,2)=="10")echo' selected="selected"'?>>Octubre</option>
		<option value="11"<? if(substr($row['fechanac'],4,2)=="11")echo' selected="selected"'?>>Noviembre</option>
		<option value="12"<? if(substr($row['fechanac'],4,2)=="12")echo' selected="selected"'?>>Diciembre</option>
	</select>
	</p>
	<p>
	...
	<select name="agnonacimiento" id="agnonacimiento" onchange="cantidias();">
		<option></option>
		<? for($i=date("Y");$i>=1900;$i--){ ?><option value="<?=$i?>"<? if(substr($row['fechanac'],0,4)==$i)echo' selected="selected"'?>><?=$i?></option> <? } ?>
	...
	<select name="sexo" id="sexo" >
		<option></option>
		<option value="masculino"<? if(strtolower($row['sexo'])=="masculino")echo' selected="selected"'?>>Masculino</option>
		<option value="femenino"<? if(strtolower($row['sexo'])=="femenino")echo' selected="selected"'?>>Femenino</option>
	</select>
	</p>
	<hr/>
	<p>
