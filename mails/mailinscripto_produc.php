    ...
    <tr valign="top"> 
      <td width="434">
        ...
        <p><font color="#808080" size="2" face="Arial, Helvetica, sans-serif"><strong>Gracias
          ...
          tu intenci&oacute;n de compra de un producto y queremos recordarte que la misma
          ...
          A las 48Hs de haberlo concretado tu pago estar&aacute; en estado
          de CONFIRMADO.</font></p>
        <p><font size="1" face="Arial, Helvetica, sans-serif"><strong>Detalles
          de la operaci&oacute;n:</strong></font></p>
        <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC">
          ...
          <tr> 
            <td><font size="1" face="Arial, Helvetica, sans-serif">Tipo de producto</font></td>
			  <td>
			  '.$nombreevento.'
			  </td>
          </tr>
          <tr> 
            <td><font size="1" face="Arial, Helvetica, sans-serif">C&oacute;digo de producto</font></td>
			  <td>
			  '.$_GET['cat'].'
			  </td>
          </tr>
...
$msg.='
        ...
        <p><font color="#808080" size="2" face="Arial, Helvetica, sans-serif">Ante
          ...
          al cliente o bien mandanos un e-mail a <a href="mailto:comercial@maritimopro.com.ar">comercial@maritimopro.com.ar</a>.</font></p>
        <p><font color="#808080" size="2" face="Arial, Helvetica, sans-serif">Record&aacute;
          ...
          y si no lo efectivizas antes de la misma, tu reserva se dar&aacute;
  ...
  <table width="600" height="25" border="0" cellpadding="0" cellspacing="5">
    <tr>
      <td><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">© Copyright 2010 / Inscribite on line es un producto de MARITIMO SRL / 4641-4423 4643-1124 / <a href="comercial@maritimopro.com.ar">comercial@maritimopro.com.ar</a> </font></td>
     </tr>
  </table>
  <p>&nbsp;</p>
</div>
