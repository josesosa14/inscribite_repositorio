   ...
   <div class="lineainicioyfinal"></div>
    <div class="header">
     ...
     <div class="gruposolapas">
      <a href="http://www.inscribiteonline.com.ar/acercade" class="solapa<? if($_SERVER['PHP_SELF']!='/acercade.php')echo 'no'?>seleccionada">Acerca de</a>
      <a href="http://www.inscribiteonline.com.ar/inscripciones" class="solapa<? if($_SERVER['PHP_SELF']!='/inscripciones.php')echo 'no'?>seleccionada">Inscripciones</a>
