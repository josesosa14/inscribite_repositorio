...
<br>
Tu inscripci&oacute;n a la capacitacion: ' . $inscripcion['evento_nombre'] . ', con la opcion: ' . $inscripcion['op_nombre'] . ' con categoria: ' . $inscripcion['cat_nombre'] . ',  ha realizarse el ' . $inscripcion['evento_fecha'] . ' ha sido confirmada a trav&eacute;s de tu pago. Ahora tenes que seguir las instrucciones del organizador.
<br>
...
Firma __________________________  Aclaraci&oacute;n _______________________________
</p>
