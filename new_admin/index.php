...
function cargarModelosPropios($class) {
    if (strpos($class, 'CI_') !== 0 && strpos($class, 'MX_') !== 0) {
        ...
        $ruta_post = DIRECTORY_SEPARATOR . "modelo" . DIRECTORY_SEPARATOR;
        $ubicaciones = array(
            $ruta_pre . "ejemplo" . $ruta_post,
            $ruta_pre . "web" . $ruta_post,
        );
        $default = APPPATH . 'libraries/modelo/' . $class . ".php";
        $encontrado = FALSE;
