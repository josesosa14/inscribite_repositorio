 ...
 */
class Mensualidad extends \Mensualidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mensualidad' . "\0" . 'id', '' . "\0" . 'Mensualidad' . "\0" . 'nombre', '' . "\0" . 'Mensualidad' . "\0" . 'codigo', '' . "\0" . 'Mensualidad' . "\0" . 'empresa'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Mensualidad $proxy) {
