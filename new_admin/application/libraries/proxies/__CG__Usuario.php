...
class Usuario extends \Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Usuario' . "\0" . 'id', '' . "\0" . 'Usuario' . "\0" . 'nombreUsuario', '' . "\0" . 'Usuario' . "\0" . 'password', '' . "\0" . 'Usuario' . "\0" . 'persona', '' . "\0" . 'Usuario' . "\0" . 'email', '' . "\0" . 'Usuario' . "\0" . 'roles', '' . "\0" . 'Usuario' . "\0" . 'activo', '' . "\0" . 'Usuario' . "\0" . 'lastlogin', '' . "\0" . 'Usuario' . "\0" . 'fechacreacion'];
        }
    ...
    public function actualizar($persona, $email, $nombre, $activo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'actualizar', [$persona, $email, $nombre, $activo]);

        return parent::actualizar($persona, $email, $nombre, $activo);
    }
    ...
    public function getArrayRoles()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getArrayRoles', []);
