 ...
 */
class Pago extends \Pago implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Pago' . "\0" . 'id', '' . "\0" . 'Pago' . "\0" . 'fechaCreacion', '' . "\0" . 'Pago' . "\0" . 'empresa', '' . "\0" . 'Pago' . "\0" . 'fechaEjecucion', '' . "\0" . 'Pago' . "\0" . 'renglones'];
        }
    ...
    public function getFechaEjecucion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFechaEjecucion', []);
    ...
    public function setFechaEjecucion($fechaEjecucion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFechaEjecucion', [$fechaEjecucion]);
    ...
    public function totalPago()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'totalPago', []);

        return parent::totalPago();
    }
