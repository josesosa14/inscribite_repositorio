 ...
 */
class Evento extends \Evento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Evento' . "\0" . 'id', '' . "\0" . 'Evento' . "\0" . 'codigo', '' . "\0" . 'Evento' . "\0" . 'ver', '' . "\0" . 'Evento' . "\0" . 'nombre', '' . "\0" . 'Evento' . "\0" . 'empresa'];
        }
