                ...
                <div align="center">
                  ...
                  <table width="600" border="0" cellspacing="5" cellpadding="0">
                    <tr>
                      <td>
<br>                    
<p>Estimado Nombre y Apellido: ' . $datos_mensualidad['nombre'] . ', ' . $datos_mensualidad['apellido'] . ' con mail: '.$datos_mensualidad['email'].'
<br>
Tu pago del servicio: ' . $datos_mensualidad['men_nombre'] . ' ha sido confirmado a trav&eacute;s de tu pago.
<br>
