            ...
            <div class="logueo" style="margin:0px;">
                <form action="" method="post" style="margin:0px;padding:0px;">
                    <div style="margin:0px;">
                        ...
                        <br/>
                        <br/>
                        <a href="<?= url ?>cerrarsesion">Cerrar Sesion</a><br/>
                        <a href="<?= url ?>usuario/<?= $row['dni'] ?>">Ver mi cuenta</a><br/>
...
<?php } else { ?>
    ...
    <?php /* <a href="registrate" style="font-size:10px">Registrate ahora</a><br/> */ ?>
            </div>
<?php } ?>
...
<?php } ?><br/>
            <a href="http://www.bristolgroup.com.ar/ec/default.php"><img src="/banners/comercio160x64.gif" alt=""/></a>
            <a href="http://www.trainersclub.com.ar/"><img src="/banners/trainers160x60.gif" alt=""/></a></div>
    </div>
