...
-->
  ...
  <body>
    ...
    <a href="usuarios?ordpor=apellido<?php if ($_GET['busqueda']!= "")echo "&amp;busqueda=".$_GET['busqueda']?>">apellido</a>,
    <a href="usuarios?ordpor=dni<?php if ($_GET['busqueda']!= "")echo "&amp;busqueda=".$_GET['busqueda']?>">dni</a>,
    <a href="usuarios?ordpor=edad<?php if ($_GET['busqueda']!= "")echo "&amp;busqueda=".$_GET['busqueda']?>">edad</a>,
    <a href="usuarios?ordpor=evento<?php if ($_GET['busqueda']!= "")echo "&amp;busqueda=".$_GET['busqueda']?>">evento</a>,
    <a href="usuarios?ordpor=puntos<?php if ($_GET['busqueda']!= "")echo "&amp;busqueda=".$_GET['busqueda']?>">puntos</a>
