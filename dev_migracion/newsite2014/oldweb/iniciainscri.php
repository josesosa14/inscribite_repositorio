...
if (!($usuario != "")) {
  echo '		<div style="margin:8px 0px 5px 19px;color:#336699;font-size:11px;">
        Por favor ingrese su DNI -------------------------------------------------------------------------------------------&gt;<br/>
          ...
          <br/><br/>Usted está logueado como <strong><?php getdatosusuario(); ?></strong><br/><br/><a href="cerrarsesion">Cerrar Sesion para registrar a otro usuario</a><br/><a href="registrate?usuario=<?=$usuario?>">Ver o cambiar mis datos</a><br/><br/>
<?php
...
<?php if ($row['tipo'] == 'Servicios') mostrarselectmeses()?>
          </div>
<?php   }
    }
  }
