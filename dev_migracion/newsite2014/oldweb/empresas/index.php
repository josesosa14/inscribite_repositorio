...
<?php }
   ...
   while ($row = mysql_fetch_array($result)) {
     $cuenta2++;
     if ($cuenta2 == 1) { ?>
      <div style="font-size:15px;<?php if ($cuenta1 > 0) echo 'margin-top:10px;'?>margin-bottom:8px;">
        Eventos offline:
      </div>
<?php   } ?>
      <div>
...
<?php } ?>
      ...
      <div class="footer">
        Inscribite on line es un producto de MARITIMO SRL / 4641-4423 4643-1124 /  <a href="mailto:comercial@maritimopro.com.ar">comercial@maritimopro.com.ar</a>
      </div>
