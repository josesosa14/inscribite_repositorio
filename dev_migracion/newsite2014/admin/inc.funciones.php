...
function LogIn() {
    ...
    if ((isset($_POST['alogin_username'])) && (isset($_POST['alogin_password']))) {
        ...
        $result1 = mysql_query($q = 'SELECT * FROM ' . pftables . 'admin_users WHERE (username = "' . $alogin_username . '" OR email = "' . $alogin_username . '") AND password = "' . chash($_POST['alogin_password']) . '" LIMIT 1');
