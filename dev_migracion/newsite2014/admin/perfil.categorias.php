...
<?php if ($tipo == 'Servicios') { ?>
    ...
    <?php
    if ($row1['fechadecomputo'] != '')
        echo"ultfechatoc[1] = document.getElementById('tocado1')" . chr(13);
    if ($row1['fechavenc1'] != '')
        echo"ultfechatoc[2] = document.getElementById('tocado2')" . chr(13);
    if ($row1['fechavenc2'] != '')
        echo"ultfechatoc[3] = document.getElementById('tocado3')" . chr(13);
    if ($row1['fechavenc3'] != '')
        echo"ultfechatoc[4] = document.getElementById('tocado4')" . chr(13);
    ?>
    -->
                </script>
    <?php
