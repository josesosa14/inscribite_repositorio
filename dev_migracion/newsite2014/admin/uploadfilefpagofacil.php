...
//while ((substr($conte, $posant,1) == 5)||(substr($conte, $posant-3,1) == 5)) {
                while (substr($conte, $posant, 1) == 5) {
                    ...
                    <tr class="cadaoperacion">
                        ...
                        <td><?=
                            substr($conte, $posant + 22, 2) . '/' . substr($conte, $posant + 20, 2) . '/' . substr($conte, $posant + 16, 4);
                            $eldni = (substr($conte, $posant + 30, 15) + 0);
                            ?></td>
...
//echo '123 '.substr($conte, $posant,10);
            ...
            if (!(substr($conte, $posant + 1, 4) > 2000))
                $posant -= 3;
        ...
        if (mysql_num_rows($result1) > 0)
            echo 'Inscripciones vencidas a borrar: (' . mysql_num_rows($result1) . ')<br/>';
        while ($row1 = mysql_fetch_array($result1)) {
        ...
        if (mysql_num_rows($result1) > 0)
            echo '<a href="borrarinscripcionesvencidas.php">Confirmar</a>' . '<br/><br/>';
