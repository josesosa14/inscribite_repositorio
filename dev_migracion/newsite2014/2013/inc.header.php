...
<body>
	<header>
		...
		<nav>
			<ul>
				<li><a href="<?=url?>"<?php                if ($perfilenurl == '')         echo ' style="color:#444"'?>>Home</a></li>
				<li><a href="<?=url?>acercade"<?php        if ($perfilenurl == 'acercade') echo ' style="color:#444"'?>>Acerca de</a></li>
				<li><a href="<?=url?>quepagar#rubros"<?php if ($perfilenurl == 'quepagar') echo ' style="color:#444"'?>>Qué pagar</a></li>
				<li><a href="<?=url?>contacto"<?php        if ($perfilenurl == 'contacto') echo ' style="color:#444"'?>>Contacto</a></li>
			</ul>
