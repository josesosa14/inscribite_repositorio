...
mysql_select_db ("inscribite_base", $conexio) OR die ("No se puede conectar");
...
<div class="cabezal"><a href="<?php echo $_SERVER['HTTP_REFERER']; ?>">Inscribite on line</a> | El usuario o la clave 
  es errónea</div>
