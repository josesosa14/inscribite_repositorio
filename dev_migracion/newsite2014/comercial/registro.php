...
?>
	...
	<input type="hidden" name="id" value="<?php if ( $_GET['usuario'] != "" ) { echo $row['id']; } else { echo 'nuevo'; } ?>" />
  ...
  <p style="text-align:center"> 
	...
	<input type="text" name="email" id="email" onchange="checkeamail();" value="<?php echo $row['email']; ?>" />&nbsp;&nbsp;<span id="avisarmalmail" style="float:left;clear:none;"></span>
  <p style="text-align:center"> 
    <label for="telefonoparticular">Teléfono:</label>
    <input type="text" name="telefonoparticular" id="telefonoparticular" <?php echo 'onkeypress'; ?>="return acceptNum(event)" value="<?php echo $row['telefonoparticular']; ?>" />
    <label for="empresa">Empresa:</label>
    <input type="text" name="telefonocelular" id="telefonocelular" value="<?php echo $row['telefonocelular']; ?>" />
  </p>
  ...
  <p style="text-align:center"> 
    ...
    <input type="text" name="dni" id="dni" <?php echo 'onkeypress'; ?>="return acceptNum(event)" value="<?php echo $row['dni']; ?>"  />
    <label for="clave">Clave:</label>
    <input type="text" name="clave" id="clave" value="<?php echo utf8_encode($row['clave']); ?>" />
  <p style="text-align:center"> 
