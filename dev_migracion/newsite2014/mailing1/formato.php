...
$msg .= '												Inscribite Online es el servicio que te permite.....<br/>'.$br;
$msg .= '											</td>'.$br;
$msg .= '										</tr>'.$br;
...
$msg .= '														<td style="margin:0;padding:0;">'.$br;
$msg .= '															<table style="border-collapse:collapse;">'.$br;
$msg .= '																Ahora también te invitamos a comunicarte con nosotros nuestra página en Facebook: <a href="http://www.facebook.com/institutoepsa">http://www.facebook.com/institutoepsa</a>.<br/>'.$br;
$msg .= '															</table>'.$br;
$msg .= '														</td>'.$br;
$msg .= '														<td style="margin:0;padding:0;width:15px;">&nbsp;</td>'.$br;
$msg .= '													</tr>'.$br;
