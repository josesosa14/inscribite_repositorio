...
<?php
$query = "  SELECT mec_id,men_id,mec_nro_cuota,men_descripcion,men_codigo,men_nombre,men_codigo,emp_nombre,meu_importe,meu_fecha,CASE WHEN meuc.meu_id is not null THEN 1 ELSE 0 END as pagado,fac_tipo
            FROM inscribite_usuarios
            INNER JOIN (select * from facturas where fac_tipo <> 0) fac ON fac.fac_usu_id = id
