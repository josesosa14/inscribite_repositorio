...
?>
<script src="<?= base_url() ?>../js/mainNew.js"></script>
...
<div id="tabs">
        ...
        <div class="col-xs-12">
            <div class="row">
                <ul>
                    ...
                    <li>
                        <div class="col-sm-3 col-wrap">
                            <a href="<?= $general_path ?>pagar.php#Capacitación" class="col category">
                                EVENTOS
                                <br/>
                                DE CAPACITACIÓN
                            </a>
    ...
    $query = "SELECT * FROM  inscribite_eventos WHERE ver=1 ORDER BY fechaord,nombre";
