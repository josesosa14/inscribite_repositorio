...
$query = "SELECT meu_importe,meu_fecha,emp_nombre,CONCAT(nombre,' ',apellido) as nombre,dni,mec_nro_cuota,mec_id,men_nombre 
			FROM mensualidades			
...
<div class="table-responsive">
	...
	data-search="true"  data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-page-size="20">
		<thead>
			<tr>
