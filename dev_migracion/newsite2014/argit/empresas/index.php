...
<html lang="es">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?=  base_root()?>css/style.css" />
        ...
        <script src="<?=  base_root()?>js/main.js"></script>
    </head>
    <body>
        <div class="container">
            ...
            <div class="top bg-7 row">
                <div class="login-container company">
                    <a href="#" class="logo"><img class="img-responsive" src="<?=  base_root()?>images/logo-empresas.png" alt=""/></a>
                    <div class="head">
                        <?php
                    ...
                    <form method="POST" action="/empresas/login.php">
                        ...
                        <div class="left">
                            ...
                            <a href="<?=base_url()?>empresas/recuperaCuenta.php" >Recupera Cuenta</a><br>
                            <a href="<?=base_url()?>empresa.php">No tengo cuenta. Registrarme</a>
                        </div>
                        <div class="right">
