...
if ((!($yaseinscribio)) && (!($inscripcioncerrada))) {
	...
	mysql_query('UPDATE ' . pftables . 'inscripciones SET pmc = 2 WHERE id = ' . $idActual);
        ...
        <body>
            <div style="float:none;width:780px;margin:0px auto;">
                ...
                <div style="float:left;width:100%;margin-bottom:13px;">
                    <img src="images/pago_rapi.png" alt="logo_rapipago" style="float:left;"/>
                ...
                <div style="float:left;width:100%;">
                    ...
                    Busque su Rapi Pago m&aacute;s cercano en e-pagofacil.com y conozca nuestro nuevo servicio de agenda.<br/>
                    Para montos superiores a $1000 dirigirse &uacute;nicamente a Centros exclusivos Pago f&aacute;cil/Rapi Pago;Suc. Correo Arg. adheridas. Si el presente recibo fue abonado dentro de las 48 horas previas al evento, el mismo deber&aacute;ser validado en la administraci&oacute;n de la organizaci&oacute;n, previo a la participaci&oacute;n en el mismo.
                            <?=
