...
<?	$paginardea = 40;
	...
	echo($limitdesde+1)?> al <?=($limitdesde+$paginardea)?> de <?=$cantproductos?> - P&aacute;gina
...
<?	$cuentachecks = 0;
	while ($row1 = mysql_fetch_array($result1)) {
        ...
        <tr>
          ...
          <td style="font-size:10px;"><? if (file_exists("filepfacil/".$row1['nombre'])) echo filesize("filepfacil/".$row1['nombre'])?></td>
...
<?		/*	<a href="#" style="float:right;clear:right;font-size:13px;margin-top:3px;">Olvidé mi contrasña</a> */ ?>
		</div>
	</form>
