  ...
  <body>
	...
	<div class="header">
	  ...
	  <div class="gruposolapas">
        <a href="acercade" class="solapa<? if($_SERVER['PHP_SELF']!='/acercade.php')echo 'no'?>seleccionada">Acerca de</a>
        <a href="inscripciones" class="solapa<? if($_SERVER['PHP_SELF']!='/inscripciones.php')echo 'no'?>seleccionada">Inscripciones</a>
        <a href="pagos" class="solapa<? if($_SERVER['PHP_SELF']!='/pagos.php')echo 'no'?>seleccionada">Pagos</a>
        <a href="promociones" class="solapa<? if($_SERVER['PHP_SELF']!='/promociones.php')echo 'no'?>seleccionada">Promociones</a>
        <a href="contacto" class="solapa<? if($_SERVER['PHP_SELF']!='/contacto.php')echo 'no'?>seleccionada">Contacto</a>
	  </div>
	</div>