<?php $result1 = mysqli_query($coneccion,'SELECT * FROM inscribite_inscripciones WHERE id = '.$_GET['editando'].' LIMIT 1 ');
...
<?
$result3 = mysqli_query($coneccion,'SELECT * FROM inscribite_categorias WHERE deevento="'.$row1['deevento'].'" ');
...
<?
$result3 = mysqli_query($coneccion,'SELECT * FROM inscribite_eventos WHERE codigo = "'.$row1['deevento'].'" ');
