...
$result1 = mysqli_query($coneccion,'SELECT '.$_GET['campo'].' FROM '.$_GET['tabla'].' WHERE id = '.$_GET['id'].' LIMIT 1 ');
$row1 = mysqli_fetch_array($result1);

if ($row1[$_GET['campo']] == 1)
  mysqli_query($coneccion,'UPDATE '.$_GET['tabla'].' SET '.$_GET['campo'].' = 0 WHERE id = '.$_GET['id']);

if ($row1[$_GET['campo']] == 0)
  mysqli_query($coneccion,'UPDATE '.$_GET['tabla'].' SET '.$_GET['campo'].' = 1 WHERE id = '.$_GET['id']);
