<?php
$result1 = mysqli_query($coneccion,'SELECT * FROM inscribite_descuentos WHERE id = ' . $_GET['editando'] . ' LIMIT 1 ');
        ...
        <form action="guardar.php" method="post">
            <div>
                ...
                <select name="codevento">
                    <?php
                    $result3 = mysqli_query($coneccion,'SELECT * FROM inscribite_eventos WHERE ver = 1 ');
