...
$result1 = mysqli_query($coneccion, 'SELECT * FROM inscribite_eventos WHERE id = ' . $_GET['editando'] . ' LIMIT 1 ');
                    ...
                    <td>
                        <div class="contselect">
                            ...
                            <select name="empresa">
                                ...
                                <?php
                                $result2 = mysqli_query($coneccion, 'SELECT * FROM empresa ');
...
//for ($i = 1; $i <= 4; $i++) {
                $cuenta = 0;
                if ($row1['codigo'] != '') {
					$query='SELECT * FROM inscribite_opciones WHERE evento = "' . $row1['codigo'] . '" ';
...
-->
            ...
            &gt; Texto particular para el cupón - <a href="#" onclick="document.getElementById('textoencupon').value = textohabitual;
                    return false;">Texto Habitual</a>
