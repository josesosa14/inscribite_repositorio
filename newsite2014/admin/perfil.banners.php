<?php
$result1 = mysqli_query($coneccion,'SELECT * FROM inscribite_banners WHERE id="' . $_GET['editando'] . '" LIMIT 1 ');
...
<?php /*        <input type="hidden" name="columna" value="2"/> */ ?>
            ...
            <div class="contselect" style="float:left;clear:left;width:100%;">
                ...
                <select name="areventos[]" multiple="multiple" size="4" style="float:left;clear:none;margin-left:7px;">
                    ...
                    <?php
                    $result2 = mysqli_query($coneccion,'SELECT * FROM inscribite_eventos WHERE ver = 1 ORDER BY nombre ASC');
