...
<form method="POST" action="altas/confirmaInscripcion.php">
    ...
    <input type="hidden" name="mes" id="dato6" value="<?php
    if (isset($_POST['mes']))
...
<script>
    ...
    $("#confirmar").click(function (event) {
        ...
        if (eleccion == "pmc") {
            ...
            var linkx = '../imprimircupon.php' + '?medio=' + eleccion + '&evento=' + d1 + '&respuesta1=' + d2 + '&respuesta2=' + d3 + '&respuesta3=' + d4 + '&cod=' + d5 + '&mes=' + d6 + '&cat=' + d7 + '&opcion=' + d9;
            location.href = linkx;
            /*
