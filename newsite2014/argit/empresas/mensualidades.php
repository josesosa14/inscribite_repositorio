...
$query = "SELECT MAX(meu_importe) meu_importe,CONCAT(mec_nro_cuota,' (mes ',MONTH(mec_venc_1),')') mec_nro_cuota,meu_u_dni,mec_id,CASE WHEN men_activo = 1 THEN 'Si' ELSE 'No' END men_activa,MAX(meu_fecha) meu_fecha,men_nombre,concat(nombre,' ',apellido) as usuario,dni
			FROM `mensualidades` 
			...
			GROUP BY mec_id,men_nombre,mec_nro_cuota,dni,nombre,apellido
...
<div class="table-responsive">
	...
	data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-page-list="[50, 100, 200,800]" data-page-size="50">
		<thead>
			<tr>
...
<div class="table-responsive">
	...
	data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-page-list="[20, 50, 100, 200,800]" data-page-size="20">
		<thead>
			<tr>
