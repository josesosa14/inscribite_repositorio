...
$mensaje = '<!DOCTYPE html>
                ...
                <body><p>se pidió una alta para el evento ' . $parameters['pevt_nombre'] . ' de la empresa ' . $_SESSION['empresa'] . '</p></body>
                </html>';


mail($email, $asunto, $mensaje, $info_adicional);*/
// Varios destinatarios
$para = 'info@inscribiteonline.com.ar'; // con coma si son m�s
...
$mensaje = '
    <html>
        ...
        <body>
            ...
            <p>se pidió una alta para el evento ' . $parameters['pevt_nombre'] . ' de la empresa ' . $_SESSION['empresa'] . '</p>
        </body>
    </html>
';
