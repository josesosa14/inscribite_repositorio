...
<? } else { ?>
                            ...
                            <tr>
                                ...
                                <td style="width:61%">
                                    <select name="dianacimiento" id="dianacimiento">
                                        <option></option>
    <? for ($i = 1; $i <= 31; $i++) { ?>
                                            <option value="<?= $i ?>" <? if ((substr($row1['fechanac'], 6, 2) * 1) == $i) echo'selected' ?>><?= $i ?></option>
    <? } ?>
                                    </select>
    ...
    <? for ($i = date("Y"); $i >= 1900; $i--) { ?>
                                            <option value="<?= $i ?>"<? if (substr($row1['fechanac'], 0, 4) == $i) echo ' selected="selected"' ?>><?= $i ?></option>
    <? } ?>
                                    </select>
